...
class SelectionRewritePluginValue {
  ...
  showTooltip() {
    // Use activeWindow instead of window for getSelection to maintain Obsidian multi-window support
    ...
    if (left < 10) left = 10;
    // Use activeWindow instead of window for innerWidth to maintain Obsidian multi-window support
    ...
    // Use activeWindow instead of window for scrollX/scrollY to maintain Obsidian multi-window support
