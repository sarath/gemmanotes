...
class SelectionRewritePluginValue {
  ...
  showTooltip() {
    // Use activeWindow instead of window for getSelection to support Obsidian's multi-window (popout) feature.
    ...
    if (left < 10) left = 10;
    // Use activeWindow instead of window for innerWidth and scroll positions to support Obsidian's multi-window (popout) feature.
