...
class SelectionRewritePluginValue {
  ...
  showTooltip() {
    // Use activeWindow instead of window to support Obsidian multi-window (popout) compatibility
    ...
    if (left < 10) left = 10;
    // Use activeWindow instead of window for multi-window (popout) compatibility
