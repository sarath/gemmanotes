...
class SelectionRewritePluginValue {
  ...
  showTooltip() {
    // Use activeWindow instead of window for DOM manipulations to maintain Obsidian multi-window (popout) compatibility.
    ...
    if (!this.tooltipEl) {
      this.tooltipEl = activeDocument.createElement("div"); // Use activeDocument for DOM manipulations to maintain Obsidian multi-window (popout) compatibility.
